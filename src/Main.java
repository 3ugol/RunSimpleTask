...
//        char[] chr = { 'O','Q','R','S'};
        System.out.println(Arge.nbYear(1500, 5, 100, 5000)); // Growth of a Population
//        System.out.println(WorkingDays.count(LocalDate.of(-999999999, 1, 1), LocalDate.of(999999999, 12, 1)));
//        System.out.println(PokerHand.sort("2H 3H 4H 5H 6H", "KS AS TS QS JS"));
//        System.out.println(PokerHandFlush.CheckIfFlush(new String[] {"10D", "4D", "9D", "KD", "5D"}));
...
//        System.out.println(Max.sequence( arr ));
//        System.out.println(Keypad.presses("WHERE DO U WANT 29 MEET L8R"));
//        System.out.println(WeightSort.orderWeight("2000 10003 1234000 44444444 9999 11 11 22 123"));
//        System.out.println(ArithmeticFunction.arithmetic(2,"add",2));
//        BouncingBall
